...
<p>So I whipped up a prototype using the <a href="https://love2d.org">Lua Löve</a> framework, tiles from Mozilla's HTML5 tech demo/lovefest, <a href="http://browserquest.mozilla.org/">BrowserQuest</a> that I found on <a href="http://opengameart.org/content/browserquest-sprites-and-tiles">Open Game Art</a>, and some <a href="http://www.youtube.com/watch?v=gwU_NupaT-s&amp;feature=related">River City Ransom</a> sprites that I had lying around. Check it out:</p>

<iframe width="640" height="480" src="http://www.youtube.com/embed/YE89_vCIkKg?rel=0" frameborder="0" allowfullscreen></iframe>
